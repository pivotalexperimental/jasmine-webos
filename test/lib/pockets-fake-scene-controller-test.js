describe("pockets.FakeSceneController", function () {
  ...
  beforeEach(function() {
    ...
    controller = new pockets.FakeSceneController({}, sceneElement, {});
  });
  ...
  describe("getSceneScroller", function () {
    ...
    it("should be undefined if disableSceneScroller is set ", function() {
      controller = new pockets.FakeSceneController({}, sceneElement, {disableSceneScroller: true});
